...
function cluster.add_node(nodename, nodeaddr)
	skynet.call(clusterd, "lua", "add_node", nodename, nodeaddr)
end

function cluster.remove_node(nodename)
	skynet.call(clusterd, "lua", "remove_node", nodename, nodeaddr)
end
